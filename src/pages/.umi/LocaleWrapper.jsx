...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/dashboard/analysis/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/user/login/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/locales/pt-BR.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/dashboard/analysis/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/dashboard/analysis/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/user/login/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/dashboard/analysis/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('E:/sln/shangshang/src/pages/user/login/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
