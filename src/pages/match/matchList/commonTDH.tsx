...
import ChangeCommonTDHModal from '../modals/ChangeCommonTDHModal';
...
class CommonTDH extends PureComponent<P> {
  state = {
    error: '',
    modalError: '',
  };
  ...
  onChangeLandlordsCommon(id, v, callback) {
    ...
    const rewards: any = [
      ...
      {
        type: v['rewardType-4'],
        itemid: v['rewardItem-4'],
        num: v['rewardNumber-4'],
      },
    ];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row' }}>
      ...
      >
        ...
        <Description term="四个最高分奖励">
          {rewards[3].name} x{rewards[3].num}
        </Description>
      </DescriptionList>
    </div>
  );
