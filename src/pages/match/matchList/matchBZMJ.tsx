...
export default class MatchBZMJ extends PureComponent {
  state = {
    error: '',
    modalError: '',
  };
    ...
    const columns: ProColumns<GithubIssueItem>[] = [
      ...
      // },
      {
        ...
        render: (_, row) => {
          ...
          return displayStartTime && displayStopTime ? (
            <>
              <Tag color="blue">
...

      {
        ...
        render: (_, row) => {
          ...
          return displayTimeStr && displayEndTimeStr ? (
            <>
              <Tag color="#5BD8A6">
                  ...
                  name: (
                    <span>
                      <Popconfirm
                        ...
                        onConfirm={() =>
                          router.push(`/match/newMatch?id=${row.id}&type=${'bz'}&tabs=2`)
                        }
                        okType="danger"
                        okText="确认"
                        cancelText="取消"
          ...
          <div style={{ width: '100%', whiteSpace: 'nowrap', overflow: 'scroll' }}>
            <ProTable<GithubIssueItem>
              ...
              request={async (params = {}) => {
                const { current, pageSize, status, rangePicker, name, type, processStatus } =
                  params || {};
