...
export default class RewardgameDDZ extends PureComponent {
  state = {
    error: '',
    modalError: '',
  };
      ...
      // },
      {
        ...
        render: (_, row) => {
          ...
          (displayStartTime && displayStopTime) ?
            <>
              <Tag color="blue">
                {moment(displayStartTime).format('YYYY/MM/DD')}-{moment(displayStopTime).format('YYYY/MM/DD')}
              </Tag>
            </>: '--'
          );
        },
                  ...
                  name: (
                    <span>
                      <Popconfirm
                        ...
                        onConfirm={() =>
                          router.push(`/match/newMatch?id=${row.id}&type=${'ddz'}&tabs=4`)
                        }
                        okType="danger"
                        okText="确认"
                        cancelText="取消"
                  ...
                  name: (
                    <span>
                      <span
                        ...
                        onClick={() => router.push(`/match/ddz-gms-info?id=${row.id}`)}
                      >
