...
class CreateMatchTDH extends React.Component<P, S> {
      ...
      <Form {...formLayout.formItemLayout} onSubmit={this.handleSubmit} layout="horizontal">
        <Card bordered={false} loading={false}>
          ...
          <Form.Item label="比赛展示日期">
            {getFieldDecorator('displayStartTime', {
              ...
              <RangePicker
                ...
                style={{ width: '100%' }}
                format="YYYY-MM-DD"
                onChange={v => this.onChangeFormValue('displayStartTime', v)}
              />,
            )}
          </Form.Item>
          ...
          <div
            style={{
              display: `${
                this.state.formValues.isRobot === 0 && getFieldValue('isRobot') === 0? 'none' : 'block'
              }`,
            }}
          >
            {extrosItems}
