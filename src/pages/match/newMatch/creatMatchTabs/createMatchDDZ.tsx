...
class CreateMatchDDZ extends React.Component<P, S> {
      ...
      easyDispatch(this, 'games/fetchMatchInfo', {
        ...
        onOk: (res: any) => {
          ...
          this.props.form.setFieldsValue({
            ...
            numberCompetitors: parseInt(res.numberCompetitors / 3),
  ...
  handleSubmit = (e: React.FormEvent) => {
    ...
    this.props.form.validateFieldsAndScroll((err: unknown, values: any) => {
      ...
      easyDispatch(this, 'games/addLandlordsMatch', {
        ...
        // 人数=桌数 * 3
        numberCompetitors: values.numberCompetitors * 3,
        players: 3,
        // 默认创建 B 级赛事
        tournamentLevel: 'B',
        // 二进制文件数据
        ...
        <Card bordered={false} loading={false}>
          ...
          <Form.Item label="赛事场数">
            {getFieldDecorator('totalMatches', {
              ...
              <InputNumber
                disabled={getFieldValue('type') === 1 || getFieldValue('type') === 4 ? true : false}
                style={{ width: '100%' }}
                min={0}
          ...
          <Form.Item label="比赛类型">
            {getFieldDecorator('type', {
              ...
              <Select placeholder="请选择赛事类型" onChange={() => this.onChangeFormValue()}>
                ...
                <Option value={4}>按时淘汰赛</Option>
                <Option value={5}>人满淘汰赛</Option>
              </Select>,
            )}
          </Form.Item>
           ...
           <div
            style={{
              display: `${
                getFieldValue('type') === 4 || getFieldValue('type') === 5 ? 'none' : 'block'
              }`,
            }}
          >
            <Form.Item label="底分">
          ...
          <Form.Item label="按时开赛时间间隔">
            {getFieldDecorator(
              ...
              <InputNumber
                disabled={getFieldValue('type') === 2 || getFieldValue('type') === 5 ? true : false}
                min={0}
          ...
          <Form.Item label="每日比赛开始-结束时间" style={{ marginBottom: 0 }}>
            <Form.Item style={{ display: 'inline-block', width: 'calc(50% - 12px)' }}>
              {getFieldDecorator('dayBeginTime', {
                rules:
                  getFieldValue('type') === 2 || getFieldValue('type') === 5
                    ? null
                    : [
                        {
                ...
                <TimePicker
                  format="HH:mm"
                  disabled={
                    getFieldValue('type') === 2 || getFieldValue('type') === 5 ? true : false
                  }
                  onChange={v => this.onChangeFormValue()}
                  style={{ width: '100%' }}
                />,
          ...
          <Form.Item label="单场桌数" help="每桌3人">
            {getFieldDecorator('numberCompetitors', {
              ...
              <InputNumber
                style={{ width: '100%' }}
                min={0}
                formatter={value => `${value}桌 ${value * 3}人`}
                parser={value => value.replace(`${value}桌 ${value * 3}人`, '')}
              />,
            )}
          </Form.Item>
