...
class CreateCommonDDZ extends React.Component<P, S> {
  ...
  render() {
    ...
    getFieldDecorator('extrosFormKeys', {
      initialValue: formValues.extrosFormKeys || [],
    });
      ...
      >
        <Card bordered={false} loading={false}>
                ...
                {getFieldDecorator(`applicationFeeItem`, {
                  ...
                  >
                    {reward[0] && getFieldValue('applicationFeeType')
                      ? reward[
                          getFieldValue('applicationFeeType') - 1
                        ].lcMatchRewards
                          .filter(
                            (it: {
                              icon: string;
          ...
          <div
            style={{
              display: `${
                this.state.formValues.isRobot === 0 &&
                getFieldValue('isRobot') === 0
                  ? 'none'
                  : 'block'
              }`,
            }}
          ...
          <Form.Item {...formLayout.tailFormItemLayout}>
            <Button
              loading={loadingaddLandlordsCommon}
              type="primary"
              htmlType="submit"
            >
              提交
