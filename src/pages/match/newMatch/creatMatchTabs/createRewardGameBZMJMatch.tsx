...
class CreateRewardGameBZMJMatch extends React.Component<P, S> {
          ...
          <Form.Item label="冠名品牌">
            {getFieldDecorator('brands', {
              ...
              <Select style={{ width: '100%' }} placeholder="请选择冠名品牌">
                {brandType[0] ? brandType.map(it => <Option key={it.id}>{it.name}</Option>) : null}
              </Select>,
            )}
          </Form.Item>
...
)(Form.create()(CreateRewardGameBZMJMatch));
