 ...
 */
export default class ChangeCommonTDHModal extends React.PureComponent {
  render() {
                ...
                <Col span={24}>
                  <Form.Item>
                    {getFieldDecorator('matchType', {
                      initialValue: info.matchType ? String(info.matchType) : '1',
                      rules: simpleRules('请选择比赛类型'),
                    })(
                      <Select style={{ width: '100%' }} key="12313">
                        <Option key={1} value={1}>初级场</Option>
                        <Option key={2} value={2}>中级场</Option>
                        <Option key={3} value={3}>高级场</Option>
                        <Option key={4} value={4}>大师场</Option>
                      </Select>,
                    )}
                  </Form.Item>
                </Col>
                    ...
                    <InputGroup key="1" style={{ width: '100%' }} compact>
                      ...
                      <Form.Item style={{ width: '35%', textAlign: 'center' }}>
                        {getFieldDecorator(`rewardItem-4`, {
                          validateTrigger: ['onChange', 'onBlur'],
                          initialValue: rewardArr[3].itemid,
                          rules: simpleRules('请选择奖励物品'),
                        })(
                          <Select style={{ width: '100%' }} placeholder="请选择奖励物品">
